...
namespace RentACar.MVC.Areas.Admin.Controllers
{
    ...
    public class OfficesController : Controller
    {
        ...
        public OfficesController(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var responseBox = JsonConvert.DeserializeObject<ResponseModel<List<OfficeResultDto>>>(jsonData);
        ...
        {
            var viewModel = new OfficeCreateDto();
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            if (resposneMessage.IsSuccessStatusCode)
            {
                ...
                var response = JsonConvert.DeserializeObject<ResponseModel<OfficeResultDto>>(jsonData);
                if (response != null && response.Data != null)
                {
                    var viewModel = new OfficeUpdateDto
                    {
                        Id = response.Data.Id,

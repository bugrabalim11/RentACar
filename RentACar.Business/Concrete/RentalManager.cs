...
namespace RentACar.Business.Concrete
{
    public class RentalManager : IRentalService
    {
        ...
        public async Task<IResult> AddAsync(RentalAddDto rentalAddDto, int userId)
        {
            ...
            await _carMaintenanceService.CheckIfCarIsAlreadyInMaintenance(rentalAddDto.CarId),
        ...
        public async Task<IResult> AddByAdminAsync(RentalAddByAdminDto rentalAddByAdminDto)
        {
            ...
            await _carMaintenanceService.CheckIfCarIsAlreadyInMaintenance(rentalAddByAdminDto.CarId),
        ...
        public async Task<IResult> UpdateAsync(RentalUpdateDto rentalUpdateDto)
        {
            ...
            await _carMaintenanceService.CheckIfCarIsAlreadyInMaintenance(rentalUpdateDto.CarId),
